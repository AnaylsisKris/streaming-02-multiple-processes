...
Let it run long enough to write ten or more records to out9.txt.

    - For the output file: 
        Option1: open a file for writing and have your code write to the file 
        Option2: manually copy and paste into the output file.

- Let us know which option you chose and why in your submission. (Option1 used for this file)
